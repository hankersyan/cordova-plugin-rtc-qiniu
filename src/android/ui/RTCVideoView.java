...
public class RTCVideoView extends FrameLayout implements View.OnLongClickListener {
    ...
    public void updateMicrophoneStateView(boolean isMute) {
        mMicrophoneStateView.setImageResource(isMute ?
                QNRtc.getResourceId("microphone_disable", "mipmap")//R.mipmap.microphone_disable
                :
                QNRtc.getResourceId("microphone_state_enable", "drawable"));//R.drawable.microphone_state_enable
    }
    ...
    protected void onFinishInflate() {
        ...
        mMicrophoneStateView = (ImageView) findViewById(QNRtc.getResourceId("microphone_state_view", "id"));//R.id.microphone_state_view
        mAudioView = (TextView) findViewById(QNRtc.getResourceId("qn_audio_view", "id"));//R.id.qn_audio_view
    }

    private int getTargetColor(int pos) {
        int[] customizedColors = mContext.getResources().getIntArray(QNRtc.getResourceId("audioBackgroundColors", "array"));//R.array.audioBackgroundColors
