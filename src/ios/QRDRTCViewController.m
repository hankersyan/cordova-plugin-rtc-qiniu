...
- (void)viewDidLoad {
    ...
    _ownMicroImageView.image = [self imageFromBundle:@"un_mute_audio"];
...
- (void)setupRTCButtonView {
    ...
    [_microphoneButton setImage:[self imageFromBundle:@"microphone"] forState:UIControlStateSelected];
    [_microphoneButton setImage:[self imageFromBundle:@"microphone-disable"] forState:UIControlStateNormal];
    ...
    [_speakerButton setImage:[self imageFromBundle:@"loudspeaker"] forState:UIControlStateSelected];
    [_speakerButton setImage:[self imageFromBundle:@"loudspeaker-disable"] forState:UIControlStateNormal];
    ...
    [_videoButton setImage:[self imageFromBundle:@"video-open"] forState:UIControlStateSelected];
    [_videoButton setImage:[self imageFromBundle:@"video-close"] forState:UIControlStateNormal];
    ...
    [_beautyButton setImage:[self imageFromBundle:@"face-beauty-open"] forState:UIControlStateSelected];
    [_beautyButton setImage:[self imageFromBundle:@"face-beauty-close"] forState:UIControlStateNormal];
    ...
    [_conferenceButton setImage:[self imageFromBundle:@"close-phone"] forState:UIControlStateNormal];
    ...
    [_toggleButton setImage:[self imageFromBundle:@"camera-switch-front"] forState:UIControlStateSelected];
    [_toggleButton setImage:[self imageFromBundle:@"camera-switch-end"] forState:UIControlStateNormal];
    ...
    [_logButton setImage:[self imageFromBundle:@"log-btn"] forState:UIControlStateNormal];
...
- (void)microphoneAction:(UIButton *)microphoneButton {
    ...
    if (self.session.muteAudio ) {
        _ownMicroImageView.image = [self imageFromBundle:@"microphone-disable"];
    } else {
        _ownMicroImageView.image = [self imageFromBundle:@"un_mute_audio"];
    }
}
...
- (UIImage*) imageFromBundle:(NSString*)name {
    NSBundle *bundle = [NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"rtc-qiniu" withExtension:@"bundle"]];
    NSString *imagePath = [bundle pathForResource:[NSString stringWithFormat:@"%@.imageset/%@", name, name] ofType:@"png"];
